...
var Editor = function () {
  ...
  _createClass(Editor, [{
    ...
    value: function selectBtnClickHandler(type) {
      ...
      if (_Util2.default.ua.platform != 'pc') {
        if (new Date().getTime() - _Util2.default.downTime > _Util2.default.touchHitTime) return;
      }
...
var Main = function () {
  function Main() {
    ...
    if (!this.aboutContainer.getElementsByClassName('twitter')[0]) {
      ...
      this.startBtns[0].addEventListener(_Util2.default.clickEventName, this.startBtnClickHandler.bind(this));
      this.startBtns[1].addEventListener(_Util2.default.clickEventName, this.startBtnClickHandler.bind(this));
    }
