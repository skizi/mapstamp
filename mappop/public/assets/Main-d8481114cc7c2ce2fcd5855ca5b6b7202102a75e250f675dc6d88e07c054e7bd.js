  ...
  _createClass(Share, [{
    ...
    value: function submit(blob) {
      ...
      if (this.provider == 'download') {
        ...
        var name = 'hoge.gif';
        var file = new File([blob], 'hoge', { type: "image/gif", lastModified: Date.now() });
        formData.append('video', file);
        // formData.append( 'message', 'hello!' );  
        //formData.append( 'access_token', Util.faceBookToken );
        //me/videos
        //me/photos
        console.log(blob);
        // console.log(file);
        ...
        // formData.append( 'source', base64data, name );
        FB.login(function () {
          FB.api('/me/videos', 'post', {
            // message : 'Hello, world!',
            source: formData
            //file_url:'https://www.mappop.me/assets/anime.gif', //動画の場合
            // url: 'https://www.mappop.me/assets/header/logo-4ba80802b13a17f231d9bd851ce011547ee8f45b8dd5972c64f6b4f217970201.png', //画像の場合
            // privacy: {
            //     value: "EVERYONE"
            // }
          },
        ...
        // var url = 'https://graph.facebook.com/v3.0/me/videos';
        // $.ajax({
        //     url:url,
        //     type:'POST',
        //     data:formData,
