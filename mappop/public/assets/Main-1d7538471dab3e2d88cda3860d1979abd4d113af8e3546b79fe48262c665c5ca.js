...
var Share = function () {
  ...
  _createClass(Share, [{
    ...
    value: function postTwitter(blob, type, message) {
      ...
      message += ' | スタンプでデコって現在地を共有できるwebサービス、MapPop！ https://www.mappop.me #MapPop Map data © OpenStreetMap';
    ...
    value: function shareFaceBook(message) {
      ...
      message += 'スタンプでデコって現在地を共有できるwebサービス、MapPop！ Map data openstreetmap.org';
