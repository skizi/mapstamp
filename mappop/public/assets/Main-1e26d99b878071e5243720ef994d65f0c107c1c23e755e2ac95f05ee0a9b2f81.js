...
var AnimationEditor = function () {
  function AnimationEditor() {
    ...
    this.btns = this.btnContainer.getElementsByTagName('li');
...
},{"./AnimationEditor":1,"./Editor":2,"./Map":4,"./Share":6,"./UserAgent":7,"./Util":8}],4:[function(require,module,exports){
'use strict';
...
},{"./PixiView":5,"./Util":8}],5:[function(require,module,exports){
'use strict';
...
var Share = function () {
  function Share() {
    ...
    btns[2].addEventListener(_Util2.default.clickEventName, this.gifBtnClickHandler.bind(this));
  ...
  _createClass(Share, [{
    ...
    value: function btnClickHandler(provider, e) {
      ...
      var name = 'hoge.gif';
      formData.append('upfile', this.blob, name);
