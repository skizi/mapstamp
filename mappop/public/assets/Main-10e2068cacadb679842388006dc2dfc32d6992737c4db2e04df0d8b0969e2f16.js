...
var Share = function () {
  ...
  _createClass(Share, [{
    ...
    value: function submitStep2(postImageId, imgType, content) {
      ...
      if (this.provider == 'download') {
        ...
        FB.ui({
          ...
          _Util2.default.loading.hideLoading();
          this.refreshFacebookDebugger(postImageId);
        }.bind(this));
    ...
    value: function refreshFacebookDebugger(postImageId) {

      var url = _Util2.default.apiHeadUrl + '/home/refresh_facebook_debugger';
      $.ajax({
        url: url,
        type: 'POST',
        data: {
