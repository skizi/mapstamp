...
var Main = function () {
  function Main() {
    ...
    document.querySelector('#form0 input').addEventListener('change', function (e) {
      ...
      var url = _Util2.default.apiHeadUrl + '/post_images/create';
      $.ajax({
        url: url,
        type: 'POST',
        data: formData,
  ...
  _createClass(Share, [{
    ...
    value: function submit(blob) {
      ...
      if (this.provider == 'download') {
        ...
        // console.log( file );
        // formData.append( 'source', file, 'anime.gif' );
        // console.log(formData.get( 'source' ));
        //formData.append( 'message', 'hello!' );  

        // var form0 = document.getElementById( 'form0' );
        // var formData2 = new FormData(form0);
        // console.log( formData2.get( 'source' ) );
        ...
        //   var url = 'https://graph.facebook.com/v2.7/' + Util.faceBookUserId + '/videos?access_token=' + e.authResponse.accessToken;
        //   $.ajax({
        //       url:url,
        //       type:'POST',
        //       data:formData,
