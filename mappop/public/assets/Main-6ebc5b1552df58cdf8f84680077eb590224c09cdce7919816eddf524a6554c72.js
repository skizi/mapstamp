  ...
  _createClass(Share, [{
    ...
    value: function submitStep2(postImageId, imgType, content) {
      ...
      if (this.provider == 'download') {
        ...
        var postImageUrl = 'https://www.mappop.me/post_images/' + postImageId;
        FB.ui({
          method: 'share',
          href: postImageUrl
        }, function (response) {
          ...
          _Util2.default.loading.hideLoading();
          this.refreshFacebookDebugger(postImageUrl);
        }.bind(this));
    ...
    key: 'refreshFacebookDebugger',
    value: function refreshFacebookDebugger(postImageUrl) {
      ...
      FB.login(function (e) {
        ...
        if (e.authResponse) {
          ...
          var url = 'https://graph.facebook.com/?scrape=true&id=' + escape(postImageUrl) + '&access_token=' + _Util2.default.faceBookToken;
          $.ajax({
            url: url,
            type: 'POST',
            data: {},
